...
public class gameframe extends JPanel implements MouseListener,
    ...
    public gameframe(){
        ...
        mysnake = new Snake(center_x, center_y, color1, color2);
        startTime = System.currentTimeMillis();
        angle = 1.0;
        boosting = false;
        map = new Map(3000.0, 3000.0);
    ...
    public void mousePressed(MouseEvent e) {
        boosting = true;
        mysnake.set_boosting(true);
    }

    @Override
    public void mouseReleased(MouseEvent e) {
        boosting = false;
        mysnake.set_boosting(false);
    }
    ...
    public void paint(Graphics g) {
        ...
        mysnake.draw_snake(g2d);
    }

    public static void main(String[] args) {
        JFrame dframe = new JFrame("Siyuan Zhang's JAVA 2D Drawing");
        ...
        dframe.addComponentListener(new ComponentAdapter() {
            ...
            public void componentResized(ComponentEvent evt) {
                ...
                mysnake.set_head_loc(center_x, center_y);
            }});
        ...
        firstcolor.addActionListener(new ActionListener(){
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                mysnake.set_color(color1, color2);
            }});
    ...
    private static void start_game(gameframe game){
        new Thread(() -> {
            ...
            while (running) {
                startTime = System.currentTimeMillis();
                if(boosting)
                    mysnake.update(angle, map, mouseloc);
                try {
                    Thread.sleep(Math.max(1, 10 - (System.currentTimeMillis() - startTime)));
